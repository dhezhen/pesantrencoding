                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a type="button" class="btn btn-outline-warning" data-toggle="modal" href="" data-target="#editMenu" data-menu_id="<?= $m['id'] ?>" data-menu_name="<?= $m['menu'] ?>">Edit</a>
                                <a type="button" class="btn btn-danger" href="<?= base_url('menu/deleteMenu/') . $m['id'] ?>" onclick="return confirm('Delete Menu <?= $m['menu'] ?> ?'  )" class="badge badge-danger">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
