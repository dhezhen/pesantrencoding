...
class User extends CI_controller
{
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            //     $this->session->set_flashdata('message', '<div class="alert alert-warning" role="alert">Gagal</div>');
            //     redirect('user/changepassword');
            // // } else {
            if ($current_password == $new_password) {
                $this->session->set_flashdata('message', '<div class="alert alert-warning" role="alert">New Password cannot be same with current password </div>');
                redirect('user/changepassword');
            } else {
                //password oke 
